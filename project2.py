...
def Student():
    try:
        ...
        obtained_marks = Semantic_Similarity.Evaluate_Paper(questions, answers, exam_name, 2)
...
def AttemptPaper():
    global main
    if (main==0):
        return render_template('AttemptPaper2.html', my_answers=my_answers,counter=counter,answerscores=answerscores,marks=marks,marks2=marks2,arr=arr,questions=questions,arr2=arr2,arr3=arr3)
        main=1
    else:
        return render_template('noattempt.html')
@app.route('/addStudent2',methods=['GET','POST'])
def Student2():
    try:
        json_data=request.json['info']
        ques1 = json_data['q1']
        ...
        exam_name += ".csv"
        print "fawad"
        path="/home/fawad/Desktop/project/MID_TERM.csv"
        q_id=[]
        questions=[]
        answerofteacher=[]
        score=[]
